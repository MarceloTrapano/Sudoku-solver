...
class ViewSudoku(ctk.CTkFrame):
    def __init__(self, master):
        ...
        for i in range(9):
            ...
            if i%3 == 2:
                bias_x += 0.01
    def reset_grid(self, all: bool=True):
        if all:
        ...
        for entry in self.entry_list:
            ...
            if entry.cget("state") == "normal":
                entry.delete(-1, "end")
    def insert(self, array: NDArray[np.int64], state='normal'):
        self.reset_grid()
    ...
    def highlight(self, array: NDArray[np.float64], true_color="green", false_color="red"):
...
class ViewConfig(ctk.CTkFrame):
    def __init__(self, master):
        ...
        disclaimer_img = ctk.CTkImage(light_image=Image.open("disclaimer.png"), dark_image=Image.open("disclaimer.png"))
        ...
        reset_img = ctk.CTkImage(light_image=Image.open("reset.png"), dark_image=Image.open("reset.png"))
        ...
        solve_img = ctk.CTkImage(light_image=Image.open("solve.png"), dark_image=Image.open("solve.png"))
        ...
        scan_img = ctk.CTkImage(light_image=Image.open("scan1.png"), dark_image=Image.open("scan1.png"))
...
class ViewPredef(ctk.CTkFrame):
    def __init__(self, master):
        ...
        id_img = ctk.CTkImage(light_image=Image.open("load.png"), dark_image=Image.open("load.png"))
